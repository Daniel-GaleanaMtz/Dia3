...
namespace DL_EF
{
    ...
    public partial class DGaleanaEcommerceEntities1 : DbContext
    {
        public DGaleanaEcommerceEntities1()
            : base("name=DGaleanaEcommerceEntities1")
        {
        }
        ...
        public virtual int ProductoAdd(string nombre, Nullable<decimal> precio, Nullable<int> stock, Nullable<int> idProveedor, Nullable<int> idDepartamento, string descripcion, byte[] images)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ProductoAdd", nombreParameter, precioParameter, stockParameter, idProveedorParameter, idDepartamentoParameter, descripcionParameter, imagesParameter);
        }
        ...
        public virtual int ProductoUpdate(Nullable<int> idProducto, string nombre, Nullable<decimal> precio, Nullable<int> stock, Nullable<int> idProveedor, Nullable<int> idDepartamento, string descripcion, byte[] images)
        {
            var idProductoParameter = idProducto.HasValue ?
                new ObjectParameter("IdProducto", idProducto) :
                new ObjectParameter("IdProducto", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ProductoUpdate", idProductoParameter, nombreParameter, precioParameter, stockParameter, idProveedorParameter, idDepartamentoParameter, descripcionParameter, imagesParameter);
        }
        ...
        public virtual ObjectResult<string> UsuarioUpdate(Nullable<int> idUsuario, string email, string userPassword, string nombre, string apellidoPaterno, string apellidoMaterno, string fechaNacimiento, string sexo, Nullable<bool> estado, Nullable<int> idRol, string telefono)
        {
            var idUsuarioParameter = idUsuario.HasValue ?
                new ObjectParameter("IdUsuario", idUsuario) :
                new ObjectParameter("IdUsuario", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("UsuarioUpdate", idUsuarioParameter, emailParameter, userPasswordParameter, nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, fechaNacimientoParameter, sexoParameter, estadoParameter, idRolParameter, telefonoParameter);
        }
    
        public virtual ObjectResult<string> UsuarioAdd(string email, string userPassword, string nombre, string apellidoPaterno, string apellidoMaterno, string fechaNacimiento, string sexo, Nullable<bool> estado, Nullable<int> idRol, string telefono)
        {
            var emailParameter = email != null ?
                new ObjectParameter("Email", email) :
                new ObjectParameter("Email", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("UsuarioAdd", emailParameter, userPasswordParameter, nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, fechaNacimientoParameter, sexoParameter, estadoParameter, idRolParameter, telefonoParameter);
        }
    }
}
